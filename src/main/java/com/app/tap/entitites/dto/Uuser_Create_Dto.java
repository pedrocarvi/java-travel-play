...
public class Uuser_Create_Dto implements Serializable {
    ...
    // Constructor vacío
    public Uuser_Create_Dto() {

    }

    // Constructor para copiar datos desde una entidad Uuser a UuserDTO
    public Uuser_Create_Dto(String userName, String email, String pssword, String firstName, String lastName, Role userRole) {
